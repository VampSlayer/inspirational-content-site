...
class Tile extends React.Component {
    ...
    async get() {
        ...
        let feed = this.props.feed ? `?feeds=${this.props.feed}` : ""
            ...
            <Container fluid className="tile">
                <Row>
                    <Col className="d-flex justify-content-between">
                        <span className="mt-1">
                            { !firstAndOnly && <i className="mi mi-Remove" title="Remove Inspiration" onClick={() => remove(id)}/> }
                            { last && <i className="mi mi-Add" title="Add Inspiration" onClick={() => add()}/> }
                        </span>
                        <span className="mt-1">
                            <i className="mi mi-Settings" title="Configure Inspiration" onClick={settings}/>
                        </span>
                    </Col>
                </Row>
